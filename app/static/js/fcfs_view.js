(function () {
    const rowsContainer = document.getElementById("fcfs-process-rows");
    const addRowBtn = document.getElementById("fcfs-add-row");
    const ganttEl = document.getElementById("fcfs-gantt");
    const timeAxisEl = document.getElementById("fcfs-time-axis");
    ...
    async function runSimulation() {
        ...
        try {
            const res = await fetch("/cpu/simulate", {
                ...
                body: JSON.stringify({ algorithm: "fcfs", processes }),
            });
